...
final class TeacherSchedulePanel extends AcademicPanel {
    ...
    TeacherSchedulePanel(VCampusClient client, String sessionToken) {
    ...
    private void loadSchedule() {
        ...
        runRequest(() -> client.teacherSchedule(sessionToken, selected.id(), null), response ->
